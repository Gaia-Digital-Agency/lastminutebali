	...
	<div class="container">
		<div class="row align-items-end g-3">
			<div class="col-lg-8">
				...
				<h2 class="heading-2 mb-0">Rooms</h2>
			</div>
		</div>

		<div class="row g-4 mt-4">
			<?php if ( $accomodations->have_posts() ) : ?>
				<?php while ( $accomodations->have_posts() ) :
					$accomodations->the_post(); ?>
					<?php $features = get_field( 'features' ); ?>
					<div class="col-12">
						<article class="accomodation-card h-100">
							<a class="accomodation-card-link h-100 d-flex flex-column flex-lg-row text-decoration-none"
								...
								<div class="accomodation-card-body d-flex flex-column flex-grow-1">
									<div class="accomodation-card-label text-uppercase mb-2">Room</div>
